(function(){
const coreset=[
{id:"patimokkhanidanan",zh:"制戒因緣",en:" ",pli:" ",def:"比丘戒制戒因緣及犯無犯相",types:"#nd_venue#nd_person",has:"#4parajika_n#13sanghadisesa_n#2aniyata_n#30nissaggiyapacittiya_n#92pacittiya_n#4patidesaniya_n#75sekhiya_n", stem:"#patimokkha"},
...
{id:"pr4n",stem:"#pr4|戒條",en:" ",pli:" ",zh:"4.不實自稱有上人法",bkn_pr:4
...
{id:"sd6n",stem:"#sd6|戒條",en:" ",pli:" ",zh:"6.無施主建屋子不合規定"
...
{id:"sd7n",stem:"#sd7|戒條",en:" ",pli:" ",zh:"7.有施主建大房子不合規定"
,nd:" #nd_gst;；某施主要為#p_channa;建大寺院，闡陀在清除地面時，砍倒一棵民眾供奉的大樹，受到譏嫌。"
,fact:"1.對象：施主發心建造的房舍。\n2.方式：(1)蓋在不清淨﹑不寬敞的地方。(2)沒有請比丘們去選定地點。"
,nooff:"1.蓋在山洞內的窯洞﹑草房。2.替別人蓋。3.比丘精神失常。"},

{id:"sd8n",stem:"#sd8|戒條",en:" ",pli:" ",zh:"8.無憑據毀謗比丘犯驅擯戒",bkn_sd:8
...
{id:"sd9n",stem:"#sd9|戒條",en:" ",pli:" ",zh:"9.穿鑿附會地毀謗比丘犯驅擯戒",bkn_sd:9
...
{id:"np1n",stem:"#np1|戒條",en:" ",pli:" ",zh:"1.非時超過十天存放額外的布",bkn_np:13
...
{id:"np2n",stem:"#np2|戒條",en:" ",pli:" ",zh:"2.離開三衣過夜",bkn_np:14
...
{id:"np3n",stem:"#np3|戒條",en:" ",pli:" ",zh:"3.非時超過一個月存放額外的布",bkn_np:15
...
{id:"np4n",stem:"#np4|戒條",en:" ",pli:" ",zh:"4.叫非親戚比丘尼整理穿過的衣服"
...
{id:"np5n",stem:"#np5|戒條",en:" ",pli:" ",zh:"5.接受非親戚比丘尼的衣服"
...
{id:"np6n",stem:"#np6|戒條",en:" ",pli:" ",zh:"6.向非親戚在家人乞衣",bkn_np:16
...
{id:"np7n",stem:"#np7|戒條",en:" ",pli:" ",zh:"7.接受非親戚在家人的過多衣料",bkn_np:17
...
{id:"np8n",stem:"#np8|戒條",en:" ",pli:" ",zh:"8.指定非親戚在家人送某種衣料",bkn_np:18
...
{id:"np9n",stem:"#np9|戒條",en:" ",pli:" ",zh:"9.指定非親戚在家人合送某種衣服",bkn_np:19
...
{id:"np10n",stem:"#np10|戒條",en:" ",pli:" ",zh:"10.向保管衣資的待者索取衣料太急",bkn_np:20
...
{id:"np11n",stem:"#np11|戒條",en:" ",pli:" ",zh:"11.做混著蠶絲的毯子"
...
{id:"np14n",stem:"#np14|戒條",en:" ",pli:" ",zh:"14.六年內做新毯子"
...
{id:"np15n",stem:"#np15|戒條",en:" ",pli:" ",zh:"15.新坐墊不加上舊坐墊的布"
...
{id:"np16n",stem:"#np16|戒條",en:" ",pli:" ",zh:"16.旅途上接受羊毛後走太遠"
...
{id:"np17n",stem:"#np17|戒條",en:" ",pli:" ",zh:"17.叫非親戚比丘尼整理羊毛"
...
{id:"np18n",stem:"#np18|戒條",en:" ",pli:" ",zh:"18.接受金銀",bkn_np:21
...
{id:"np19n",stem:"#np19|戒條",en:" ",pli:" ",zh:"19.買賣金銀",bkn_np:22
,nd:" #nd_ap;，#p_chabbaggiya;從事各種貴重金屬及貨幣的交易，居士們批評這是在家人的行為，並不是出家人應該做的。"
,fact:"1.對象：貴重金屬(*)。2.方式：買賣交易。"
,nooff:"1.比丘精神失常。"},

{id:"np20n",stem:"#np20|戒條",en:" ",pli:" ",zh:"20.買賣物品",bkn_np:23
,nd:" #nd_ap;，#p_upananda;和一位遊學的人交換外衣，後來遊學者後悔交換，想要換回來，優婆難陀不肯，遊學者大為不滿。"
,fact:"1.對象：物品(*)。2.方式：買賣、交易。"
,nooff:"1.問了價格後，命執事人(*)去交換。2.比丘精神失常。"},

{id:"np21n",stem:"#np21|戒條",en:" ",pli:" ",zh:"21.存放額外的缽超過十天",bkn_np:22
,nd:" #nd_ng;，#p_chabbaggiya;命比丘尼洗羊毛，導致比丘尼們無暇精進於道業。"
,fact:"1.對象：沒有親戚關係的比丘尼。2.方式：命令她們(1)洗﹑(2)染﹑(3)梳理羊毛(*)。"
,nooff:"1.有親戚關係的比丘尼洗時，沒有親戚關係的比丘尼幫忙。2.沒有親戚關係的比丘尼自行拿去洗。3.洗沒有用過的羊毛(*)。4.由式叉摩那﹑沙彌尼洗。5.比丘精神失常。"},

{id:"np22n",stem:"#np22|戒條",en:" ",pli:" ",zh:"22.以未滿五綴的缽換新缽",bkn_np:24
...
{id:"np23n",stem:"#np23|戒條",en:" ",pli:" ",zh:"23.七日藥(儲存最多儲存七天) ",bkn_np:25
...
{id:"np24n",stem:"#np24|戒條",en:" ",pli:" ",zh:"24.提前乞求和使用雨衣"
...
{id:"np25n",stem:"#np25|戒條",en:" ",pli:" ",zh:"25.送衣服後奪回",bkn_np:26
...
{id:"np26n",stem:"#np26|戒條",en:" ",pli:" ",zh:"26.叫織工織絲成布",bkn_np:27
...
{id:"np27n",stem:"#np27|戒條",en:" ",pli:" ",zh:"27.未受請而命令織工如何織布",bkn_np:28
...
{id:"np28n",stem:"#np28|戒條",en:" ",pli:" ",zh:"28.存放急施衣超過做衣服的時間",bkn_np:29
...
{id:"np29n",stem:"#np29|戒條",en:" ",pli:" ",zh:"29.有難離衣宿超過六夜"
...
{id:"np30n",stem:"#np30|戒條",en:" ",pli:" ",zh:"30.轉供養僧團的物品為己有",bkn_np:30
...
{id:"adhikarana",zh:"7解決案件的規則",en:" ",pli:"Adhikaraṇa samathā",has:"#ak1n#ak2n#ak3n#ak4n#ak5n#ak6n#ak7n"},
